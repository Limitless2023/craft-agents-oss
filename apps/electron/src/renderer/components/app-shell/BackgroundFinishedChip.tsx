 ...
 *
 * A small accent-colored pill that floats in the top-right corner *inside* the chat
        ...
        >
          <button
            ...
            className={cn(
              ...
              'shadow-[0_2px_10px_color-mix(in_srgb,var(--accent)_20%,transparent)] backdrop-blur-md',
            )}
          >
