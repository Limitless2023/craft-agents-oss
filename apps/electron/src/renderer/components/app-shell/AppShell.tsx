...
function AppShellContent({
  ...
  }), [contextValue, handleDeleteSession, sources, skills, activeSessionWorkingDirectory, displayLabelConfigs, handleSessionLabelsChange, enabledModes, effectiveSessionStatuses, handleSessionSourcesChange, handleJumpToTaskSessions, isAutoCompact, searchActive, searchQuery, handleChatMatchInfoChange, handleTestAutomation, handleToggleAutomation, handleDuplicateAutomation, handleDeleteAutomation, automationTestResults, getAutomationHistory, handleReplayAutomation, toggleRightSidebar, isRightSidebarOpen, rightSidebarPanel, infoPopoverOpen, focusedSessionId])
    ...
    <AppShellProvider value={appShellContextValue}>
      ...
      >
        <PanelStackContainer
          ...
          navigatorWidth={isFavoritesNavigation(navState) || isVizGalleryNavigation(navState) ? 0 : (isAutoCompact ? sessionListWidth : (effectiveSidebarAndNavigatorHidden || isBoardView || isPagesView ? 0 : sessionListWidth))}
