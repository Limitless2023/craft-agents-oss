        ...
        <>
          ...
          <div className={cn(
            ...
            {item.lastMessageRole === 'plan' && (
              <svg className="text-success h-3.5 w-3.5 animate-attention" viewBox="0 0 25 24" fill="currentColor">
            ...
            {hasPendingPrompt && <ShieldAlert className="h-3.5 w-3.5 text-info animate-attention" />}
          </div>
        </>
      }
