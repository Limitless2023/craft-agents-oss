...
favorites-highlight-store.ts: 临时跳转高亮信号（request/peek/consume/subscribe）；非持久化 [Task 6]
favorites-highlight-store.test.ts: 高亮信号单测 [Task 6]
FavoritesPage.tsx: 收藏页视图，列出/取消/点击跳回原对话（requestHighlight + navigate）[Task 5-6]
